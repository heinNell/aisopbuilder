    ...
    <div className="max-w-6xl mx-auto">
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-3xl font-bold text-gradient tracking-tight">Generate New SOP</h2>
            <p className="text-slate-400 mt-1.5 font-light">Create a professional SOP from scratch</p>
          </div>
        </div>
        ...
        {generatedSOP && (
          ...
          >
            <div className="flex items-center justify-between">
              <h3 className="text-xl font-bold text-white tracking-tight">Generated SOP</h3>
